...
// grow but cap it at max-h-[160px] (scrolls internally beyond that), and lock
...
//
// 160px is a compromise: tall enough to show a multi-sentence description
// without internal scrolling in the common case, but bounded so that a single
// long entry can't stretch a table row down the page. Callers that need more
// room for a specific column can pass a larger max-h via className to override.
//
...
const AUTO_CLASSES = "field-sizing-content max-h-[160px] overflow-y-auto";
